...
EOD;
    ...
    public function cleanamazonordersAction()
    {
        ...
        // Run sql
        $result = $db->query('UPDATE ' . $tableName . ' SET paymentmethod = "channelunitypayment" WHERE paymentmethod IN ("amzpaymentmethodcom", "amzpaymentmethodde", "amzpaymentmethodfr", "amzpaymentmethoduk")');
